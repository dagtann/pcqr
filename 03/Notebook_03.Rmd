...
The following chunk repeats our inclass solution. The code contains a semantic error. In other words, it does not return what we expect. Can you spot and fix the error? Hint: Try different parameter settings.
